	...
	<v-container class="mt-15">
		<v-row class="mb-15">
			...
			<v-col lg="8" md="6" sm="12">
				...
				<v-btn color="primary" large elevation="0" :disabled="product.numberInStock < 1" @click="placeOrder(product)">Place your Order</v-btn>
			</v-col>
		</v-row>
		<v-row>
			<v-col cols="12">
...
<script>
	...
	export default {
		...
		methods: {
			...mapActions(["fetchProductByID", "placeOrder"]),
		},
		computed: {
			...mapState(["product"]),
		},
